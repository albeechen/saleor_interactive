...
class PageForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {"slug": forms.TextInput(attrs={"placeholder": "example-slug"})}
        labels = {
            "title": pgettext_lazy("Page form: title field", "Title"),
        ...
        help_texts = {
            "slug": pgettext_lazy(
                "Form field help text", "Slug is being used to create page URL"
            )
        }

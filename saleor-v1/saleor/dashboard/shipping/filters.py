...
from django_filters import CharFilter, ChoiceFilter, OrderingFilter, RangeFilter
...
class ShippingZoneFilter(SortedFilterSet):
    name = CharFilter(
        label=pgettext_lazy("Shipping zones list filter label", "Shipping zone name"),
    ...
    def get_summary_message(self):
        ...
        return npgettext(
            "Number of matching records in the dashboard " "shipping zones list",

      ...
      if (!store.isEmpty) {
        ...
        if (displayGross) {
          ...
          if (availability.priceRangeLocalCurrency) {
            priceLocalCurrency =
              availability.priceRangeLocalCurrency.minPrice.grossLocalized;
          }
        } else {
          ...
          if (availability.priceRangeLocalCurrency) {
            priceLocalCurrency =
              availability.priceRangeLocalCurrency.minPrice.netLocalized;
          }
        }
      }
      return (
        <h2 className="product__info__price">
          ...
          {priceLocalCurrency && (
            <p>
              <small className="text-info">&asymp; {priceLocalCurrency}</small>
            </p>
          )}
          {handleTaxes && [
            displayGross ? (
